...
class App:
    ...
    def __init__(self, master):
        ...
        # Instance Tree
        self.instance_tree_frame = tk.Frame(self.bottom_frame, padx=10, pady=10)
        self.instance_tree_frame.grid(row=0, column=0, sticky="nsew")
        ...
        self.instance_tree_scrollbar_v = ttk.Scrollbar(self.instance_tree_frame, orient='vertical', command=self.instance_tree.yview)
        self.instance_tree_scrollbar_h = ttk.Scrollbar(self.instance_tree_frame, orient='horizontal', command=self.instance_tree.xview)
        self.instance_tree.configure(yscrollcommand=self.instance_tree_scrollbar_v.set, xscrollcommand=self.instance_tree_scrollbar_h.set)
        self.instance_tree.pack(side='left', fill="both", expand=True)
        self.instance_tree_scrollbar_v.pack(side='right', fill='y')
        self.instance_tree_scrollbar_h.pack(side='bottom', fill='x')

        # Separator
        self.separator = ttk.Separator(self.bottom_frame, orient='vertical')
        self.separator.grid(row=0, column=1, sticky='ns')
        self.separator.bind("<Button-1>", self.start_drag)
        self.separator.bind("<B1-Motion>", self.drag_separator)
    
        # Data
        self.data_frame = tk.Frame(self.bottom_frame, padx=10, pady=10)
        ...
        self.data_text_scrollbar_v = ttk.Scrollbar(self.data_frame, orient='vertical', command=self.data_text.yview)
        self.data_text_scrollbar_h = ttk.Scrollbar(self.data_frame, orient='horizontal', command=self.data_text.xview)
        self.data_text.configure(yscrollcommand=self.data_text_scrollbar_v.set, xscrollcommand=self.data_text_scrollbar_h.set)
        self.data_text.pack(side='left', fill="both", expand=True)
        self.data_text_scrollbar_v.pack(side='right', fill='y')
        self.data_text_scrollbar_h.pack(side='bottom', fill='x')
    ...
    def drag_separator(self, event):
        delta_x = event.x - self.start_x
        cur_width = self.bottom_frame
